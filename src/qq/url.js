...
module.exports = {
    ...
    selfInfo: 'http://s.web2.qq.com/api/get_self_info2&t=0.1',
    ...
    buddyInfo: (uin, vfwebqq, psessionid) => `http://s.web2.qq.com/api/get_friend_info2?tuin=${uin}&vfwebqq=${vfwebqq}&clientid=53999199&psessionid=${psessionid}&t=0.1`,
    buddyQQID: (uin, vfwebqq) => `http://s.web2.qq.com/api/get_friend_uin2?tuid=${uin}&type=1&vfwebqq=${vfwebqq}&t=0.1`,
    ...
    discuInfo: (discuss_id, psessionid, vfwebqq) => `http://d1.web2.qq.com/channel/get_discu_info?did=${discuss_id}&psessionid=${psessionid}&vfwebqq=${vfwebqq}&clientid=53999199&t=0.1`,
    getGroup: 'http://s.web2.qq.com/api/get_group_name_list_mask2',
    groupInfo: (group_code, vfwebqq) => `http://s.web2.qq.com/api/get_group_info_ext2?gcode=${group_code}&vfwebqq=${vfwebqq}&t=0.1`
};